...
public class Quiz extends JFrame implements ActionListener {
    ...
    Quiz(String name) {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/Quiz_display.jpg"));
        ...
        lifeline.setBounds(300, 600, 200, 40);
        ...
        submit.setBounds(550, 600, 150, 40);
    ...
    public void paint(Graphics g) {
        ...
        if (timer > 0) {
            g.drawString(time,750,450);
        } else {
            g.drawString("Times up!!",750,450);
        }
